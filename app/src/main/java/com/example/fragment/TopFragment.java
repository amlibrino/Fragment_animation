...
public class TopFragment extends Fragment {
    ...
    private com.example.fragment.Fragment fragment;
    ...
    public void onAttach(Context context) {
        ...
        if(context instanceof com.example.fragment.Fragment){
            this.fragment = (com.example.fragment.Fragment) context;
        }
    }
    ...
    private void applyText() {
        ...
        this.fragment.showText(topText,bottomText);
    }
}